EditorsFriend = require '../lib/editors-friend'
  ...
  describe "when the editors-friend:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        editorsFriendElement = workspaceElement.querySelector('.editors-friend')
        expect(editorsFriendElement).toExist()

        editorsFriendPanel = atom.workspace.panelForItem(editorsFriendElement)
